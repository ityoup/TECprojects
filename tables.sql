...
create table infoAlumnos(idUser int ,semestre int, imagen varchar(255) ,materiasFav varchar(255), maestrosFav varchar(255), tecUni varchar(255), ciudad varchar(255), email varchar(255) ,numTel varchar(255), cumple varchar(255), foreign key(idUser) references login(idUser));
