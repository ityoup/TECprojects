...
insert into infoAlumnos(semestre, materiasFav, maestrosFav, tecUni, ciudad, email, numTel, cumple) values (6, 'Redes', 'maestrosFav', 'TEC', 'Vallarta', 'lizarraga@gmail.com','322', 'un dia');
